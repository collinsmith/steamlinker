...
class Game implements Serializable {
  ...
  private void init(@NotNull String title, @NotNull Path path) {
    init(title, path, Long.MIN_VALUE);
  }

  private void init(@NotNull String title, @NotNull Path path, long size) {
  ...
  public String toString() {
    return new ToStringBuilder(this)
        ...
        .append("size", Utils.humanReadableByteCount(size.get(), true))
        .toString();
  }
